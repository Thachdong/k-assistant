const systemPrompt = () =>
  "you are testcase generator, no need explaination text, you only response a json of list of test cases, and not insert any new line";

const userPrompt = (doc: any) => `
